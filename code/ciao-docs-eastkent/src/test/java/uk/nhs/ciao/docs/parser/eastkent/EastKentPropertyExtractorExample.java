...
public class EastKentPropertyExtractorExample {
	...
	public static void main(final String[] args) throws Exception {
		...
		for (final String name: Arrays.asList("Example6.htm", "Example7.htm", "Example8.htm", "Example9.htm", "Example10.htm")) {
			...
			System.out.println();
			String result = example.parseResource("/input/" + name);
			FileWriter.writeFile("src/test/resources/parsed-actual/"+name, result.getBytes());
	 ...
	 */
	public String parseResource(final String resourceName) throws UnsupportedDocumentTypeException, IOException {
